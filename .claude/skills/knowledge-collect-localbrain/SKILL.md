...
# Knowledge Collect (LocalBrain) v0.6.0
...
Access the web UI at `http://127.0.0.1:8080` (or your configured port).
...
# Search for items
curl "http://127.0.0.1:8080/api/search?q=python"

# Semantic search
curl -X POST http://127.0.0.1:8080/api/search/semantic \
